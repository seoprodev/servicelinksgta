                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                             ...
                             <div class="d-flex align-items-center flex-wrap">
                                <a class="nav-link btn btn-linear-primary" href="#" data-bs-toggle="modal" data-bs-target="#cleint-sign-up">
                                    <i class="ti ti-user-filled me-2"></i>Post a Job
                                </a>
                                
                                <a class="nav-link btn btn-linear-primary ms-2" href="#" data-bs-toggle="modal" data-bs-target="#provider-sign-up">
