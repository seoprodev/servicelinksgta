        ...
        @forelse($leads as $lead)
            <div class="card shadow-none booking-list border-left">
                <div class="card-body d-md-flex align-items-center">
                        ...
                        <div class="booking-det-info">
                            ...
                            <ul class="booking-details">
                                <li class="d-flex align-items-center mb-2">
                                    ...
                                    {{ $lead->job->category->name ?? 'N/A' }} &nbsp;&nbsp;&nbsp;

                                    <i class="ti ti-map-pin me-2"></i>
                                    {{ $lead->job->city ?? 'Unknown' }}, {{ $lead->job->country ?? '' }} &nbsp;&nbsp;&nbsp;

                                    <i class="ti ti-clock me-2"></i>
                                    {{ $lead->job->created_at->diffForHumans() }}
                                </li>

                                <li class="d-flex align-items-center mb-2">
                                    <span class="book-item font-weight-bold">Client Budget</span>
                                    <small class="mx-2">:</small>
                                    ${{ $lead->job->budget ?? 'N/A' }} / {{ $lead->job->payment_type ?? 'fixed' }}
                                </li>
                                ...
                                <li class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="user-book d-flex align-items-center flex-wrap">
                                        <span class="me-4">{{ $lead->job->user->name ?? 'Unknown' }}</span>
                                    </div>
                                    <p class="mb-0 me-2">
                    ...
                    <a href="{{ route('provider.my.lead.show', $lead->faker_id) }}"  class="btn btn-success payment">
                        View Detail
                    </a>
                </div>
            </div>
