...
{{--                        </li>--}}
                        ...
                        <li class="d-none d-lg-block">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle d-flex align-items-center boo language-selects"
            ...
            <div class="header-btn d-flex align-items-center">
                <div class="provider-head-links d-block d-sm-none">
                    <ul class="main-nav align-items-lg-center list-menus">
                        <li>
                            <div class="dropdown">
                                <button class="btn dropdown-toggle d-flex align-items-center booo language-selects"
            ...
            <div class="header-btn d-flex align-items-center">
                <div class="provider-head-links d-block d-sm-none">
                    <ul class="main-nav align-items-lg-center list-menus">
                        <li>
                            <div class="dropdown">
                                <button class="btn dropdown-toggle d-flex align-items-center boo language-selects" type="button" data-bs-toggle="dropdown" aria-expanded="false">
