...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="{{ asset('admin-assets/img/logo.png') }}" class="header-logo" />
            </a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.manage.user') }}">Manage Users</a></li>
                    <li><a class="nav-link" href="{{ route('admin.create.user') }}">Create New User</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                            data-feather="credit-card"></i><span>Package Management</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.manage.package') }}">Manage Package</a></li>
                    <li><a class="nav-link" href="{{ route('admin.create.package') }}">Create New Package</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                            data-feather="filter"></i><span>Category Management</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.manage.category') }}">Manage Category</a></li>
                    <li><a class="nav-link" href="{{ route('admin.create.category') }}">Create New Category</a></li>
                </ul>
            </li>
